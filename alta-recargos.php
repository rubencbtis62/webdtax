...
<head>
  ...
  <title>Registro / Recargos - Apc Accounting Services</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Registro Recargo</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Modulo Registro de factores de Recargos</h5>
              <div>Solo el responsable supervisor asignado, creará registro de recargo del periodo o ejercicio fiscal, la gestión y su mantenimiento.</div>
              <div>En cumplimiento a lo dispuesto en el artículo 3° de la Ley de Ingresos de la Ciudad de México para el Ejercicio Fiscal 2024 y con fundamento en los artículos 6, 7, fracción III, 39, 42, 45 y 49 del Código Fiscal de la Ciudad de México y 28, fracción XXIX y 92, fracción VIII del Reglamento Interior del Poder Ejecutivo y de la Administración Pública de la Ciudad de México</div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body">
             ...
             <div class="row mb-2">
              ...
              <!-- <h5 class="card-title">Registro Indice Nacional de precios al Consumidor (recargo)</h5> -->

              <!-- General Form Elements -->
              <form role="form" action="php/crecargo.php" method="POST" class="needs-validation" novalidate>
                <input type="hidden" name="accion" value="alta">
                <div class="row">
                  <div class="alert alert-primary alert-dismissible fade show" role="alert">Registro Tasa de Recargos</div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-2">
                    <button type="submit" class="btn btn-primary" name="enviar">Guardar Registro</button>
                  </div>
