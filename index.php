...
<head>
  ...
  <title>Dashboard - Apc Accounting Services</title>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Empresas Recientes <span>| Hoy</span></h5>
                  ...
                  <table class="table table-borderless datatable table-striped table-hover ">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Angus Grady</td>
                        <td><class="text-primar">Personas Prof. y Fisica</class></td>
                        <td>Juan Eduardo Larrañaga</td>
                        <td><span class="badge bg-danger">Modificación</span></td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#">#2644</a></th>
                        <td>Raheem Lehner</td>
                        <td><class="text-primary">Personas Morales Titulo II</class></td>
                        <td>Rodolfo Adrian Hernandez </td>
                        <td><span class="badge bg-success">Consulta</span></td>
                      </tr>
                    </tbody>
                  </table>
